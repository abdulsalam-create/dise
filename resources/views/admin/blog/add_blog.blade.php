            ...
            <div class="col-sm-12 col-xl-12">
                <div class="bg-secondary rounded h-100 p-4">
                    ...
                    <section>
                        ...
                        <div class="form-floating ">
                            <div class="form-floating mb-3">
                                <textarea name="desc" id="trumbowyg-editor"
                        ...
                        <div class="form-floating ">
                            <div class="form-floating mb-3">
                                <textarea name="f_desc" id="trumbowyg-editor"
                                    placeholder="Start typing here..."></textarea>
                            </div>
                        </div>
                        <div class="form-floating">
                            <div class="mb-3">
                                <input class="form-control bg-dark" name="f_img" type="file" id="image-upload1" required title="Please select an image">
                        ...
                        <div class="form-floating">
                            <div class="mb-3">
                                <input class="form-control bg-dark" name="f_img2" type="file" id="image-upload2" required title="Please select an image">
                    ...
                    <div class="form-floating ">
                        <div class="form-floating mb-3">
                            <textarea name="b_conc_d" id="trumbowyg-editor"
                                placeholder="Start typing here..."></textarea>
                        </div>
