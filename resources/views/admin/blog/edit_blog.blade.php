            ...
            <div class="col-sm-12 col-xl-12">
                <div class="bg-secondary rounded h-100 p-4">
                    ...
                    <section>
                        ...
                        <div class="form-floating ">
                            <div class="form-floating mb-3">
                                <textarea name="desc" id="trumbowyg-editor-2"
                                    placeholder="Start typing here...">{{$item->b_desc}}</textarea>
                            </div>
                        ...
                        <div class="form-floating ">
                            <div class="form-floating mb-3">
                                <textarea name="f_desc" id="trumbowyg-editor-3"
                                    placeholder="Start typing here...">{{$item->b_desc1}}</textarea>
                            </div>
                    ...
                    <div class="form-floating ">
                        <div class="form-floating mb-3">
                            <textarea name="b_conc_d" id="trumbowyg-editor"
                                placeholder="Start typing here...">{{$item->b_conc_d}}</textarea>
                        </div>
