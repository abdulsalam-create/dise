...
class BlogController extends Controller
{
    ...
    public function AddBlog()
    {
        ...
        return view('admin.blog.add_Blog', compact('addBlog', 'categories'));
    }
    ...
    public function EditBlog($id)
    {
        ...
        return view('admin.blog.edit_blog', compact('editBlog', 'allBlog', 'categories'));
    }
    ...
    public function ViewBlog($id)
    {
        ...
        $previousPost = Blog::where('id', '<', $editBlog->id)->orderBy('id', 'desc')->first();
        $nextPost = Blog::where('id', '>', $editBlog->id)->orderBy('id', 'asc')->first();
        $ccount = Testimonial::all()->count();
        $items = Blog::where('category_id', $editBlog->category->id)
    ->inRandomOrder()
    ->limit(3)
    ->get();


        return view('view_blog', compact('editBlog', 'allBlog', 'previousPost', 'nextPost', 'ccount', 'testimonial', 'items'));
    }
